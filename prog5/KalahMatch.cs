...
namespace Mankalah
{
    ...
    public class KalahMatch {
        ...
        private static Player pTop = new AlphaBetaPlayer(Position.Top, timeLimit);	// TOP player (MAX)
        private static Player pBot = new sc77Player(Position.Bottom, timeLimit);	// BOTTOM player	
